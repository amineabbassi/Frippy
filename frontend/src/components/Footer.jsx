    ...
    <div>
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
            ...
            <div>
                ...
                <ul className='flex flex-col gap-1 text-gray-600'>
                    <li>+216 54 051 820</li>
                    <li>contact.Frippy@info.com</li>
                </ul>
            </div>
        </div>
        <div>
            <hr />
            <p className='py-5 text-sm text-center'>Copyright 2025 Frippy. All rights reserved.</p>
        </div>
    </div>
  )
}
