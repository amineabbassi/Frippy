...
const NavBar = () => {
  ...
  return (
    <div className='flex bg-gradient-to-b from-white/100 via-white/90 to-white/80 items-center justify-between py-5 font-medium'>
        <Link to='/'>
            <img src={assets.logo} className='w-24' alt="Trendify" />
        </Link>
